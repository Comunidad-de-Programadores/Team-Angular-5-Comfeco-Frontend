...
import { SetCurrentPage, AddAreaToUser, AddUserActivity, AddUserEvent, GetAllGroups, GetCurrentUserProfile, GetAllBadges, GetAllEvents } from "./user-profile.actions";
...
@State({
  ...
  defaults: {
    ...
    groups: [], // TODO: definir interface
    badges: [], // TODO: definir interface
    activities: [], // TODO: definir interface
    events:[],
