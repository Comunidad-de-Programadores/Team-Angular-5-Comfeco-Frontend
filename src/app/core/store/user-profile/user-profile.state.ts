...
import { SetCurrentPage, AddAreaToUser, AddUserActivity, AddUserEvent } from "./user-profile.actions";
...
@State({
  ...
  defaults: {
    ...
    badgets: [], // TODO: definir interface
...
export class UserProfileState{
  ...
  @Selector()
  static getUserActivities(state:UserProfileStateModel){return state.activities}
