...
@State({
  ...
  defaults: {
    ...
    user: {
      ...
      userName:'',
      email:'',
      areas:['Frontend','Backend'], // TODO: @odprz remove when the logic has been updated
      nick:'alejandra Mariel orozco',// TODO: @odprz remove when the logic has been updated
      // TODO: @odprz remove when the logic has been updated
    ...
    } , // TODO: @odprz Cambiar tipo a interface usuario cuando este definida
    groups: [],
    badges: [],
    activities: [],
    events:[],
